...
def transform(df, *args, **kwargs):
    ...
    #Rebuilding data frame with new created columns
    ...
    #Building Fact table Merging dim and declaring columns.
    ...
    #Passing the dataframes to a dict for loading into BigQuery
